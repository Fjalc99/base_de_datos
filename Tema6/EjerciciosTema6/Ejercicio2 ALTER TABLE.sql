...
ALTER TABLE libro ADD FOREIGN KEY (dni_autor) REFERENCES autor (dni)
ALTER TABLE libro ADD FOREIGN KEY (cod_genero) REFERENCES genero (id_genero)
ALTER TABLE libro ADD FOREIGN KEY (cod_editorial) REFERENCES editorial (cod_editorial)
ALTER TABLE edicion ADD FOREIGN KEY (isbn) REFERENCES libro (isbn)