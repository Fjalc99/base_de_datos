...
CREATE TABLE libro(
	...
	CONSTRAINT fk_dni_autor FOREIGN KEY (dni_autor) REFERENCES autor (dni), 
	CONSTRAINT fk_cod_genero FOREIGN KEY (cod_genero) REFERENCES genero (id_genero),
...
CREATE TABLE edicion (
	...
	CONSTRAINT fk_isbn_edicion FOREIGN KEY (isbn) REFERENCES libro 
)